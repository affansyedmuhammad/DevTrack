    ...
    return(
        ...
        <br/>
           <form class="form-group" method='POST' action='http://localhost:9000/createacc'>
            ...
            Enter your email: <input type="text" onInput={(e)=>{setemail(e.target.value)}} class="form-control-lg" name="email" value={email}/><br/><br/>
            ...
            <button style={{marginLeft:"10%"}} class="btn btn-danger" onClick={(e)=>{e.preventDefault();setusername("");setemail("");setpassword("");setconfirmpassword("")}}>Clear</button>
